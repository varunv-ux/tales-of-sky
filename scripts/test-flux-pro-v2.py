#!/usr/bin/env python3
"""
Test Flux 2 Pro with safety_tolerance=5 and max quality.
Usage: REPLICATE_API_TOKEN=xxx python3 scripts/test-flux-pro-v2.py
"""
...
OUTPUT_DIR = Path("public/weather-images/test-pro-v2")
