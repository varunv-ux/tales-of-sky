#!/usr/bin/env python3
"""
Generate Seattle Watercolor-style images with varied landmarks per condition/season.
...
OUTPUT_DIR = Path("public/weather-images/seattle-watercolor")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

API_URL = "https://api.replicate.com/v1/models/black-forest-labs/flux-2-dev/predictions"
STYLE = "in watercolor style, soft edges, flowing colors, artistic, luminous atmosphere, high detail, no text"
MAX_PARALLEL = 4
...
total = len(jobs)
print(f"=== Seattle Watercolor — Varied Landmarks ===")
